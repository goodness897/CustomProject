...
public abstract class WheelPicker extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos
            ...
            paint.setTextSize(Util.convertDpToPixel(16));
...
//            }
            if (hasAtmospheric) {
                ...
                int textSize = (int)((drawnCenterY - Math.abs(drawnCenterY - mDrawnItemCenterY)) * 1.0F
                        / drawnCenterY
                        * 28);
                textSize = textSize < 16 ? 16: textSize;
                paint.setTextSize(Util.convertDpToPixel(textSize));
            }
...
//                paint.setTextSize(Util.convertDpToPixel(24));
//                paint.setTextSize(Util.convertDpToPixel(28));

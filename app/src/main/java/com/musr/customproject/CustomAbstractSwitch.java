...
public abstract class CustomAbstractSwitch extends RelativeLayout
    ...
    protected void setupLayout() {
        ...
        mImgToggle = (SquareImageView)findViewById(R.id.switch_view_toggle);
        mImgBkg = (ImageView)findViewById(R.id.switch_view_bkg);
        mContainerLayout = (RelativeLayout)findViewById(R.id.switch_view_container);
